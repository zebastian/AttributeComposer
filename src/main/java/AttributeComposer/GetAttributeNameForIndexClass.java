...
public class GetAttributeNameForIndexClass extends Command implements TangoConst {
     ...
     */
    // ===============================================================
    public GetAttributeNameForIndexClass(final String name, final int in, final int out) {
	super(name, in, out);
    }
     ...
     */
    // ===============================================================
    public GetAttributeNameForIndexClass(final String name, final int in, final int out, final String in_comments,
