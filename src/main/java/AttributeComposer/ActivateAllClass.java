...
public class ActivateAllClass extends Command implements TangoConst {
     ...
     */
    // ===============================================================
    public ActivateAllClass(final String name, final int in, final int out) {
	super(name, in, out);
    }
     ...
     */
    // ===============================================================
    public ActivateAllClass(final String name, final int in, final int out, final String in_comments,
